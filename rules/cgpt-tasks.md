...
- `src/components/Map.jsx` – React component rendering the interactive world map using OpenLayers with detailed GeoJSON data, coloring countries based on the Quality of Living Index with red-to-green gradient, filter support, AI recommendation pins, and integrated country profile navigation
...
- `src/components/CountryProfile.jsx` – React component displaying detailed criterion data for selected country with comprehensive breakdown, historical trends, global comparison, and analysis insights
